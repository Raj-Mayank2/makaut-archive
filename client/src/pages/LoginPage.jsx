...
const LoginPage = () => {
  ...
  // Get the login function FROM THE CONTEXT. It will handle the API call.
  const { login } = useAuth();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Call the single 'login' function from our context. 
      // It will call the service, set the state, and handle localStorage.
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl border border-white/40 p-8 space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-gray-600 font-medium">
              Sign in to access your <span className="text-blue-600 font-semibold">Makaut Archives</span>
            </p>
        ...
        <div className="text-center mt-8">
          <div className="inline-flex items-center space-x-2 bg-white/60 backdrop-blur-sm rounded-full px-6 py-3 shadow-lg border border-white/40">
            ...
            <span className="text-sm text-gray-600 font-medium">Secure Login Portal</span>
          </div>
        </div>
      </div>
    </div>
